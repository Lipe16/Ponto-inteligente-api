package ferreira.filipe.pontointeligente.api.controllers;
...
import ferreira.filipe.pontointeligente.api.dtos.CadastroPFDto;
import ferreira.filipe.pontointeligente.api.entities.Empresa;
import ferreira.filipe.pontointeligente.api.entities.Funcionario;
import ferreira.filipe.pontointeligente.api.enums.PerfilEnum;
import ferreira.filipe.pontointeligente.api.response.Response;
import ferreira.filipe.pontointeligente.api.services.EmpresaService;
import ferreira.filipe.pontointeligente.api.services.FuncionarioService;
import ferreira.filipe.pontointeligente.api.utils.PasswordUtils;
...
public class CadastroPFController {
	...
	public ResponseEntity<Response<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
		...
		validarDadosExistentes(cadastroPFDto, result);//metodo de validação lá em baixo
