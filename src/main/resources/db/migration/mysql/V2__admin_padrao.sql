...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Ferreira Programação');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@felipao.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
